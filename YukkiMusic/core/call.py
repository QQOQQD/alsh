    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**لم يتم العثور على محادثة صوتية نشطة**\ n\nالرجاء التأكد من تمكين الدردشة الصوتية للمجموعة. إذا تم التمكين بالفعل ، فالرجاء إنهائه وبدء محادثة صوتية جديدة مرة أخرى وإذا استمرت المشكلة ، فحاول /restart"
                )
            ...
            raise AssistantErr(
                "**خطأ في خادم تليكرام**\n\nيواجه Telegram بعض مشكلات الخادم الداخلي ، يرجى محاولة التشغيل مرة أخرى.\n\n إذا استمرت هذه المشكلة في الظهور في كل مرة ، فيرجى إنهاء الدردشة الصوتية وبدء محادثة صوتية جديدة مرة أخرى."
            )
